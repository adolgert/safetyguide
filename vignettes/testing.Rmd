...
-   Overton, *Numerical Computing with IEEE Floating Point Arithmetic*, is available throught the UW library, and it gives a basic howto for getting through floating-point calculations when things look incorrect.
